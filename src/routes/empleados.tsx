...
export const Route = createFileRoute("/empleados")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestión de empleados registrados en el sistema TimeCore." },
    ],
  }),
                    ...
                    >
                      <span
                        className={`h-1.5 w-1.5 rounded-full ${
                          e.estado === "Activo" ? "bg-success" : "bg-muted-foreground"
                        }`}
                      />
                      {e.estado}
                    </span>
          ...
          <div className="w-full max-w-lg rounded-xl bg-card border border-border shadow-xl">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Field label="Código" defaultValue={editing?.codigo} placeholder="EMP-009" />
                <Field label="Nombre completo" defaultValue={editing?.nombre} placeholder="Nombre Apellido" />
                <Field label="Puesto" defaultValue={editing?.puesto} placeholder="Ej. Gerente" />
