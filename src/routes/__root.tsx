...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TimeCore — Control Biométrico" },
      { name: "description", content: "Sistema centralizado de administración de relojes biométricos ZKTeco para múltiples sucursales." },
      { property: "og:title", content: "TimeCore — Control Biométrico" },
